...
;;
;; Author: rathurvaron <rathurvaron@arthurmanjaro>
...
(defconst matlab-packages
	'(
    company
    (emacs-matlab :location "~/.spacemacs.d/layers/matlab/matlab-emacs-src")
    ))

(defun matlab/post-init-company ()
  (spacemacs|add-company-backends :backends company-matlab-shell
                                  :modes (matlab-shell-mode))
  )

(defun matlab/init-emacs-matlab ()
...
;; (defun matlab/post-init-lsp ()
;;   (add-to-list 'lsp-language-id-configuration
;;                '(matlab-mode . "matlab-lsp"))

;;   (lsp-register-client
;;    (make-lsp-client :new-connection (lsp-stdio-connection "theme-"))))
